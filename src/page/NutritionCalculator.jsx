...
import { Form, Input, Button, Radio, Select, Row, Col, Modal, Breadcrumb } from 'antd';
...
const NutritionCalculator = () => {
    ...
    const [macronutrients, setMacronutrients] = useState({ carbs: 0, protein: 0, fat: 0 });
    ...
    const pieData = {
        ...
        datasets: [
            {
                data: [macronutrients.carbs, macronutrients.protein, macronutrients.fat],
        ...
        <div>
            ...
            <div className="container" style={{ marginTop: '100px' }}>
                ...
                <Form layout="vertical" onFinish={onFinish}>
                    ...
                    <Form.Item label="Height (cm)" name="height" rules={[{ required: true, message: 'Please enter your height' }]}>
                        <Input type="number" />
                    </Form.Item>

                    <Form.Item label="Weight (kg)" name="weight" rules={[{ required: true, message: 'Please enter your weight' }]}>
                        <Input type="number" />
                    </Form.Item>

                    <Form.Item label="Activity Level" name="activityLevel" rules={[{ required: true, message: 'Please select your activity level' }]}>
                ...
                >
                    {loading ? (
                        ...
                        <div>
                            ...
                            <p>Carbohydrates: {macronutrients.carbs.toFixed(0)} grams per day</p>
